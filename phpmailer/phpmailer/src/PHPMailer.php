...
//            $result .= static::$LE;
    ...
    public function do_encode_text($str)
    {
        $re = '/\[E([QB]{1})\'(.+)\']/m';
        ...
        {
            echo $match[2];
            $str = str_replace($match[0], $this->encode_text($match[2],'Q') , $str);
        }
        return $str;
    }

    public function encode_text($str,$encoding,$cherseter='none')
    {
        $position = 'text';
        if($cherseter!='none')
        {
            $charset = strtoupper ($cherseter);
        }
        elseif ($this->has8bitChars($str)) {
            $charset = $this->CharSet;
        } else {
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        //echo "MATCH COUNTER $str : $matchcount \n";
        $matchcount = 11;
        if($matchcount == 11)
        {
            $encoding = false;
        }
        elseif ($matchcount > strlen($str) / 3) {
